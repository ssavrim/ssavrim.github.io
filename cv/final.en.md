...
**Software Engineer** · Aug 2013 — Jul 2017

- Designed and implemented services based on microservice architectures.
- Developed web and backend components using Python and JavaScript-based technologies.
- Improved automated test integration in Continuous Integration pipelines.
- Deployed software solutions on scalable and highly available infrastructure.
- Debugged complex interactions across applications, HTTP-based services and infrastructure.
...
- **GitLab Co-Create** — Participated in a session as [@ssavrim](https://gitlab.com/ssavrim); [proposed a merge request](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/204549) to expand variables in CI/CD `rules:if` conditions.
- **[build-on-demand](https://gitlab.com/grouperenault/build-on-demand)** — Principal contributor to a user interface for triggering GitLab builds on demand.
...
Engineer’s Degree — Network & Telecommunications  
2000 — 2005
